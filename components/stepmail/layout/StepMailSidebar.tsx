  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
      <div className="p-6 border-b border-gray-200">
        <Link href="/stepmail" className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">AI 마케팅 엔진</p>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 space-y-1">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700 rounded-lg transition-colors"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
